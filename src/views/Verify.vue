  ...
  >
   <template v-slot:top>
            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field v-model="editedItem.verify" label="verify (g)"></v-text-field>
                  </v-col>
                </v-row>
              </v-container>
            </v-card-text>
    ...
    <template v-slot:item.action="{ item }">
      ...
      <v-btn :v-show="item.verify=='verified'"  color="primary" dark class="mb-2" @click="verifyTeacher(item)">verify</v-btn>
      <!-- <v-icon
        small
